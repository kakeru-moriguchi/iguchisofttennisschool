...
const TIER_STYLE = {
  vip: {
    card: "border-gold-600/40 bg-navy-900 text-white",
    ...
    button:
      "bg-gold-500 text-navy-900 hover:bg-gold-400 shadow-lg shadow-gold-600/20",
    tone: "gold" as const,
    ribbon: "特別クラス",
  },
  ex: {
  ...
  regular: {
    card: "border-navy-100 bg-white text-navy-900",
    accent: "text-sky-brand-dark",
    badge: "bg-sky-brand text-white",
    priceText: "text-navy-800",
    label: "text-slate-500",
    body: "text-slate-600",
    divider: "border-navy-100",
    button: "bg-sky-brand text-white hover:bg-sky-brand-dark",
    tone: "brand" as const,
    ribbon: null,
  },
  service: {
    card: "border-navy-100 bg-navy-50 text-navy-900",
    accent: "text-navy-600",
    badge: "bg-navy-700 text-white",
    priceText: "text-navy-800",
    label: "text-slate-500",
    body: "text-slate-600",
    divider: "border-navy-200",
